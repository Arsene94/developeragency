...
const Footer: React.FC = () => {
  ...
  const isAdmin = location.pathname.startsWith('/zjadminwebarcats');
  ...
  return (
    <footer className={`bg-gray-900 text-white pt-16 pb-8 ${isAdmin ? 'pl-64' : ''}`}>
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <button
            onClick={scrollToTop}
            className="fixed bottom-4 right-4 bg-gray-800 hover:bg-teal-500 text-white p-2 rounded-full transition-all duration-200"
