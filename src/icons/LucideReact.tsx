import {
    ...
    ShoppingBag, ShoppingCart, Shuffle, Sidebar, Slack, Slash, Sliders,
    ...
    ToggleLeft, ToggleRight, Trash, Trash2, Trello, TrendingDown,
    ...
    WifiOff, Wind, X, XCircle, XOctagon, XSquare, Youtube, Zap, ZapOff,
